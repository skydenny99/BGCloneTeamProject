...
void AInventoryTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Completed, this, &AInventoryTestCharacter::MoveReleased);
...
void AInventoryTestCharacter::MoveReleased(const FInputActionValue& Value)
{
	if (Controller != nullptr)
		bUseControllerRotationYaw = false;
}
...
void AInventoryTestCharacter::Look(const FInputActionValue& Value)
{
	...
	if (Controller != nullptr)
	{
		...
		float NewYaw = FMath::Clamp(CurrentYaw + LookAxisVector.X, MinYaw, MaxYaw);
		
		
		// add yaw and pitch input to controller
		AddControllerYawInput(NewYaw - CurrentYaw);
